                ...
                <div className={`${style.main_gallery_wrapper} ${style.flex_container}`}>
                    <div className={`${style.card_wrapper} ${style.flex_container}`}>
                        <div className={style.card_header}>
                            ...
                            {link ? <Link className={style.card_title} to={`/user/${author}`}>{author}</Link> : <p className={style.card_title}>{author}</p>}
                            {
                                setBlogs &&
                                <Dropdown state={{ title, body, status, id, images }} setBlogs={setBlogs} />
                            }
                        </div>
                        ...
                        <div className={style.blogFooter}>
                            ...
                            <div>
                                ...
                                <Link to={`/posts/${from}/${id}/`}>more...</Link>
                            </div>
                        </div>
                    </div>
                </div>
